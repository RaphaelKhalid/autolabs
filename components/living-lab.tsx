  ...
  return (
    <main className={`living-lab phase-${phase} ${meeting ? 'is-tessellating' : ''}`}>
      ...
      <header className="lab-header">
        ...
        <nav aria-label="Experiments"><a href="/studio">Create a lab</a><a href="/experiments">Experiments</a><a href="/research">Research</a><a href="/experiments/reward-compatibility">Experiment 002</a></nav>
        <div>
