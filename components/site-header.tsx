...
const researchDestinations: Destination[] = [
  ...
  { href: '/experiments/persona-discovery-3c', label: 'Experiment 3C', description: 'Live SAE run, visual run replay, survivability record', keywords: 'experiment 3c sae sparse autoencoder walkthrough replay runpod live' },
];
