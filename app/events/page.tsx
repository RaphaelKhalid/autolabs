...
export default function EventsPage() {
  ...
  return (
    <main className="events-page">
      ...
      `}</style>
      <nav className="events-nav"><Link href="/">A / AUTOLABS</Link><div className="events-nav-links"><Link href="/experiments">Experiments</Link><Link href="/research">Research</Link><Link href="/studio">Studio</Link></div></nav>
